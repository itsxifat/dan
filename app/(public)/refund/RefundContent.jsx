...
function RefundIcon() {
  return (
    <svg viewBox="0 0 22 22" width="18" height="18" fill="none" stroke="currentColor"
      ...
      <path d="M4 11a7 7 0 1 1 2.05 4.95" />
      <path d="M4 15.5V11h4.5" />
    </svg>
  );
}
...
export default function RefundContent({ doc = {}, contactInfo = {} }) {
  const [activeSection, setActiveSection] = useState(0);
  const sectionRefs = useRef([]);
  const heroRef = useRef(null);
  const heroInView = useInView(heroRef, { once: true });

  const title         = doc.title         || "Refund & Cancellation Policy";
    ...
    <>
      ...
      <section ref={heroRef}
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-8 lg:px-14 text-center">
          ...
          >
            Plans change. Here&apos;s how cancellations and refunds work for your booking.
          </motion.p>
                ...
                <div className="sticky top-24">
                  ...
                  <div className="mt-8 mx-3 p-4 rounded-xl bg-[#7A2267]/[0.05] border border-[#7A2267]/10">
                    ...
                    <p className={`${josefin.className} text-[10.5px] font-light text-[#7a6a52] leading-[1.7]`}>
                      Cancel more than 72 hours before check-in for a full refund.
                    </p>
                  </div>
                </div>
              </aside>
