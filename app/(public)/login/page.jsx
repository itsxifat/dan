...
export default function LoginPage() {
  ...
  // Staggered Animation Variants for a smooth, premium entrance
  ...
  return (
    <div className={`min-h-[100dvh] w-full flex flex-col items-center justify-center bg-[#Faf9f8] px-4 py-12 sm:px-6 lg:px-8 ${montserrat.className}`}>
      ...
      <motion.div
        ...
        className="text-center mb-10 sm:mb-12 w-full flex justify-center"
      >
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleCredentialsLogin} className="space-y-6 sm:space-y-8">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-[#fcfcfc] border border-gray-100 focus:bg-white focus:border-[#7A2267]/30 focus:shadow-[0_0_15px_rgba(122,34,103,0.05)] px-5 py-4 sm:px-6 sm:py-4 rounded-xl text-sm transition-all duration-300 outline-none text-[#1a1a1a] placeholder:text-gray-300"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                <label className="text-[9px] sm:text-[10px] uppercase tracking-[0.2em] text-gray-500 font-bold">
                  Password
                </label>
                <Link href="/forgot-password" className="text-[9px] sm:text-[10px] uppercase tracking-widest text-[#7A2267] font-bold hover:text-[#5a184c] transition-colors">
                  Forgot?
                </Link>
              </div>
              <input
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#1a1a1a] text-white py-5 sm:py-5 rounded-xl text-[10px] sm:text-[11px] uppercase tracking-[0.3em] font-bold hover:bg-[#7A2267] transition-all duration-500 shadow-lg shadow-black/10 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed mt-2"
            >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 sm:gap-4 border border-gray-200 py-4 sm:py-4 rounded-xl hover:bg-[#fcfcfc] hover:border-gray-300 transition-all duration-300 active:scale-[0.98] group"
          >
        ...
        <motion.div variants={itemVariants} className="mt-8 sm:mt-10 text-center">
          <p className="text-[10px] sm:text-[11px] text-gray-400 font-light tracking-wide">
            ...
            <Link href="/signup" className="text-[#7A2267] font-semibold hover:text-[#5a184c] hover:underline ml-1 transition-colors">
              Create an account
            </Link>
          </p>
        </motion.div>
