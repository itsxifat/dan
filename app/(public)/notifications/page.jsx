      ...
      <div className="relative bg-[#0f0a0d] pt-32 pb-16 px-4 overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <p className={`${josefin.className} text-[9px] uppercase tracking-[0.38em] text-[#c9a96e] font-semibold`}>
              Your Updates
            </p>
            <div className="h-px w-8 bg-[#c9a96e]/50" />
          </div>
          <h1 className={`text-[2.4rem] font-light text-white leading-tight ${lora.className}`}>
            Notifications
          </h1>
          {unreadCount > 0 && (
            <p className={`${josefin.className} mt-3 text-[12px] text-[#c9a96e]/70`}>
