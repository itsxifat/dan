...
export const metadata = { title: "Delivery Policy — Admin" };
...
export default async function DeliveryAdminPage() {
  ...
  const data = await getLegalDocument("delivery");

  return (
    <div className="p-6 lg:p-8 space-y-6">
      <PageHeader
        title="Delivery Policy"
        subtitle="Manage the public Delivery Policy document"
        action={
          <Link
            href="/delivery"
            target="_blank"
