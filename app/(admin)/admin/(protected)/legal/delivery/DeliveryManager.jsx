    ...
    <div className="bg-white/[0.025] border border-white/[0.07] rounded-2xl p-5 space-y-4 group">
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g. Booking Confirmation Delivery"
        />
      </div>
...
export default function DeliveryManager({ data }) {
  ...
  const [form, setForm] = useState({
    title:         data.title         ?? "Delivery Policy",
  ...
  function handleSave(e) {
    ...
    startTransition(async () => {
      try {
        await updateLegalDocument("delivery", form);
        setSaved(true);
      } catch (err) {
      ...
      <div className={CARD}>
        ...
        <div>
          ...
          <textarea className={TEXTAREA} rows={4}
            ...
            placeholder="A brief introduction shown at the top of the Delivery Policy page…" />
