...
export const metadata = { title: "Terms & Conditions — Admin" };
...
export default async function TermsAdminPage() {
  ...
  const data = await getLegalDocument("terms");

  return (
    <div className="p-6 lg:p-8 space-y-6">
      <PageHeader
        title="Terms & Conditions"
        subtitle="Manage the public Terms & Conditions document"
        action={
          <Link
            href="/terms"
            target="_blank"
