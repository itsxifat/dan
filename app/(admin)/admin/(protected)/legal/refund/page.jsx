...
export const metadata = { title: "Refund & Cancellation Policy — Admin" };
...
export default async function RefundAdminPage() {
  ...
  const data = await getLegalDocument("refund");

  return (
    <div className="p-6 lg:p-8 space-y-6">
      <PageHeader
        title="Refund & Cancellation Policy"
        subtitle="Manage the public Refund & Cancellation Policy document"
        action={
          <Link
            href="/refund"
            target="_blank"
